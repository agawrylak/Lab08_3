...
public class MagazynBazaDanych extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String sqlString2 = "CREATE TABLE Historia (_id INTEGER PRIMARY KEY AUTOINCREMENT, DATE TEXT,  ITEM TEXT,  OLD_QUANTITY TEXT,  NEW_QUANTITY TEXT)";
